                ...
                for *xyxy, conf, cls in det:
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if ret:
                            ...
                            xyxy2=[290,210,350,270]
                            #cv2.circle(frame,(xyxy[0],xyxy[1]), 5, (0,0,255), -1)
                            # cv2.circle(frame_RGB,(160,100), 5, (0,0,255), -1)
                            # cv2.circle(frame_RGB,(560,400), 5, (0,0,255), -1)
                            # cv2.circle(frame_RGB,(560,100), 5, (0,0,255), -1)
                            imgt = tempImage[xyxy2[1]:xyxy2[3],xyxy2[0]:xyxy2[2]]
                            # imgt = tempImage[y1:y2,x1:x2]]
                            minVal, maxVal, minLoc, maxLoc = cv2.minMaxLoc(imgt)
                            maxLoc = (maxLoc[0] + xyxy[0], maxLoc[1] + xyxy[1]) #x1 y1
                            cv2.rectangle(frame, (xyxy2[0],xyxy2[1]), (xyxy2[2],xyxy2[3]), (255,0,0), 1)
