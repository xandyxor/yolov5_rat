...
out_TH = cv2.VideoWriter(str(time_data)+'.avi', fourcc_TH, 23, (640, 480))

while cap_th.isOpened() and cap_RGB.isOpened():
    ...
    xyxy=[245,132,480,343]
    #cv2.rectangle(frame_RGB, (xyxy[0],xyxy[1]), (xyxy[2],xyxy[3]), (0,255,0), 1)
    xyxy=[180,50,580,350]
    #cv2.rectangle(frame_RGB, (xyxy[0],xyxy[1]), (xyxy[2],xyxy[3]), (0,0,255), 1)

    # cv2.circle(frame_RGB,(180,50), 5, (0,0,255), -1)
    img = frame_RGB[xyxy[1]:xyxy[3],xyxy[0]:xyxy[2]]
    # cv2.circle(frame_RGB,(160,400), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(160,100), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(560,400), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(560,100), 5, (0,0,255), -1)
    # frame_RGB = frame_RGB[100:400,160:560]
    # frame_RGB = frame_RGB[50:350,180:580]
    frame_RGB = cv2.resize(frame_RGB,(640,480))
    ...
    xyxy=[290,210,350,270]
    #cv2.circle(frame,(xyxy[0],xyxy[1]), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(160,100), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(560,400), 5, (0,0,255), -1)
    # cv2.circle(frame_RGB,(560,100), 5, (0,0,255), -1)
    imgt = tempImage[xyxy[1]:xyxy[3],xyxy[0]:xyxy[2]]
    ...
    print(minVal,maxVal,ktoc(minVal),ktoc(maxVal))
#         deg = tempavg(frame,int(60),int(50),int(100),int(70))
#         deg = (deg/10)+25
    #cv2.rectangle(frame, (xyxy[0],xyxy[1]), (xyxy[2],xyxy[3]), (0,255,0), 1)
    xyxy=[245,132,480,343]
    xyxy_temp = fix_xyxy(int(xyxy[0]),int(xyxy[1]),int(xyxy[2]),int(xyxy[3]))
    #print(xyxy_temp)
    #cv2.rectangle(frame, (xyxy[0],xyxy[1]), (xyxy[2],xyxy[3]), (255,0,0), 1)

    text = str(deg)
    #cv2.putText(frame, text, (160, 180), cv2.FONT_HERSHEY_PLAIN,1, (0, 255, 0), 1, cv2.LINE_AA)
#         cv2.putText(影像, 文字, 座標, 字型, 大小, 顏色, 線條寬度, 線條種類)
#         frame = cv2.resize(frame,(640,480))
#         cv2.circle(frame,(160,400), 5, (0,0,255), -1)
#         cv2.circle(frame,(160,100), 5, (0,0,255), -1)
#         cv2.circle(frame,(560,400), 5, (0,0,255), -1)
#         cv2.circle(frame,(560,100), 5, (0,0,255), -1)
#         crop_img = frame[100:400, 160:560]
